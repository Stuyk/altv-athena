...
[client/rmlui/menu/menuInterfaces.ts:62](https://github.com/Stuyk/altv-athena/blob/d9b1cbb/src/core/client/rmlui/menu/menuInterfaces.ts#L62)

___

### options

• **options**: (`string` \| `number` \| { `key`: `string` ; `value`: `any`  })[]

The available values for this option.

#### Defined in

[client/rmlui/menu/menuInterfaces.ts:46](https://github.com/Stuyk/altv-athena/blob/d9b1cbb/src/core/client/rmlui/menu/menuInterfaces.ts#L46)
...
[client/rmlui/menu/menuInterfaces.ts:38](https://github.com/Stuyk/altv-athena/blob/d9b1cbb/src/core/client/rmlui/menu/menuInterfaces.ts#L38)
...
[client/rmlui/menu/menuInterfaces.ts:54](https://github.com/Stuyk/altv-athena/blob/d9b1cbb/src/core/client/rmlui/menu/menuInterfaces.ts#L54)
