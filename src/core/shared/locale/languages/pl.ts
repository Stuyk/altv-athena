...
export default {
    // Commands
    [LOCALE_KEYS.COMMAND_ADMIN_CHAT]: `_%_ [message] - Admin chat`,
    [LOCALE_KEYS.COMMAND_ACCEPT_DEATH]: `_%_ - Odródź sie w szpitalu po śmierci`,
    [LOCALE_KEYS.COMMAND_ACTION_MENU]: `_%_ - Create a test action menu`,
    [LOCALE_KEYS.COMMAND_ADD_VEHICLE]: `_%_ [model] - Dodaj pojazd do twojej postaci`,
    [LOCALE_KEYS.COMMAND_ADD_WHITELIST]: `_%_ [discord] - Dodaj na whiteliste po Discord ID`,
    [LOCALE_KEYS.COMMAND_OOC]: `_%_ [message] - Użyj czatu OOC`,
    [LOCALE_KEYS.COMMAND_BROADCAST]: `_%_ [message] - Ogłoś wiadomość serversideowo`,
    [LOCALE_KEYS.COMMAND_COORDS]: `_%_ [x] [y] [z] - Teleportuj na koordynaty`,
    [LOCALE_KEYS.COMMAND_DO]: `_%_ [message] - Opisz dźwięki, obiekty etc.`,
    [LOCALE_KEYS.COMMAND_DUMMY_ITEM]: `_%_ - Get some debug items`,
    [LOCALE_KEYS.COMMAND_GET_ITEM]: `_%_ [item-name] - Zdobądź item po nazwie`,
    [LOCALE_KEYS.COMMAND_LOW]: `_%_ [message] - Szepcz`,
    [LOCALE_KEYS.COMMAND_MOD_CHAT]: `_%_ [message] - Wyslij wiadomosc do moderatorów`,
    [LOCALE_KEYS.COMMAND_ME]: `_%_ [message] - Opisz akcje roleplay`,
    [LOCALE_KEYS.COMMAND_NO_CLIP]: `_%_ - Włącz noclip`,
    [LOCALE_KEYS.COMMAND_QUIT_JOB]: `_%_ - Wyjdz z pracy`,
    [LOCALE_KEYS.COMMAND_REMOVE_ALL_WEAPONS]: `_%_ - Usuń wszystkie bronie`,
    [LOCALE_KEYS.COMMAND_REMOVE_WHITELIST]: `_%_ [discord] - Usun Discord ID z whitelisty`,
    [LOCALE_KEYS.COMMAND_REVIVE]: `_%_ [player_id]* - Ożyw siebie albo kogoś innego`,
    [LOCALE_KEYS.COMMAND_SEATBELT]: `_%_ - Zapnij pasy, lub załóż kask`,
    [LOCALE_KEYS.COMMAND_SET_ARMOUR]: `_%_ [0-100][player_id]* - Ustaw pancerz`,
    [LOCALE_KEYS.COMMAND_SET_CASH]: `_%_ [value] - Ustaw pieniądze w gotówce`,
    [LOCALE_KEYS.COMMAND_SET_FOOD]: `_%_ [0-100] - Ustaw poziom głodu`,
    [LOCALE_KEYS.COMMAND_SET_HEALTH]: `_%_ [99-199][player_id]* - Ustaw zdrowie dla siebie lub kogoś innego`,
    [LOCALE_KEYS.COMMAND_SET_WATER]: `_%_ [0-100] - Ustaw poziom spragnienia`,
    [LOCALE_KEYS.COMMAND_SPAWN_VEHICLE]: `_%_ [index] - Spawnuj swoje auto po ID`,
    [LOCALE_KEYS.COMMAND_TELEPORTER]: `_%_ - Teleport back to current location with an item`,
    [LOCALE_KEYS.COMMAND_TELEPORT_WAYPOINT]: `_%_ - Teleport to waypoint`,
    [LOCALE_KEYS.COMMAND_TOGGLE_VEH_LOCK]: `_%_ - Zablokuj auto`,
    [LOCALE_KEYS.COMMAND_TOGGLE_VEH_DOOR]: `_%_ - [0-5] - Zablokuj konkretne drzwi`,
    [LOCALE_KEYS.COMMAND_TOGGLE_ENGINE]: `_%_ - Włącz silnik`,
    ...
    [LOCALE_KEYS.COMMAND_WHISPER]: `_%_ [player_id][message] - Prywatna wiadomosc do gracza w pobliżu`,
    [LOCALE_KEYS.COMMAND_WEAPON]: `_%_ [name] - Dodaj broń po nazwie`,
    [LOCALE_KEYS.COMMAND_CLEAR_INVENTORY]: `_%_ - Wyczyść EQ`,
    [LOCALE_KEYS.COMMAND_CLEAR_TOOLBAR]: `_%_ - Wyczyść toolbar`,
    [LOCALE_KEYS.COMMAND_CLEAR_EQUIPMENT]: `_%_ - Pozbądź sie wyposażenia`,
    [LOCALE_KEYS.COMMAND_NOT_PERMITTED_CHARACTER]: `Niewystarczające permisje dla tej postaci.`,
    [LOCALE_KEYS.COMMAND_NOT_PERMITTED_ADMIN]: `Nie wystarczające permisje dla tego konta.`,
    [LOCALE_KEYS.COMMAND_NOT_VALID]: `_%_ nie jest poprawną komendą.`,
    [LOCALE_KEYS.COMMAND_SET_WEATHER]: `_%_ [weather name] - Zmień pogode`,
    [LOCALE_KEYS.COMMAND_CLEAR_WEATHER]: `_%_ - Wyłącz podmiane pogody`,
    [LOCALE_KEYS.COMMAND_SET_TIME]: `_%_ [hour] - Nadpisz godzine`,
    [LOCALE_KEYS.COMMAND_CLEAR_TIME]: `_%_ - Usun nadpisanie godziny`,
    // Cannot
