    ...
    template: `
        <v-container class="containerHelper transparent">
            <div class="d-flex flex-column justify-space-between fill-height" block fluid>
                <v-card
                    v-for="(name, i) in colorOverlays"
                    :key="i"
                    class="d-flex flex-column elevation-2 mb-3 pa-3 grey darken-3 fill-height"
                >
                    ...
                    <div class="d-flex flex-row flex-grow-1">
                        <v-chip class="light-blue--text mr-3" label outlined
                            >{{ parseFloat(data.colorOverlays[i].opacity).toFixed(1) }}</v-chip
                        >
                        <v-slider
                            thumb-label
                            dense
