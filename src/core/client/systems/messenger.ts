...
export const MessengerSystem = {
     ...
     */
    registerHistoryCallback(callback: HistoryCallback) {
     ...
     */
    setCommands(_commands: Array<Omit<MessageCommand<alt.Player>, 'callback'>>) {
     ...
     */
    getCommands(): Array<Omit<MessageCommand<alt.Player>, 'callback'>> {
        return commands;
    },
};
