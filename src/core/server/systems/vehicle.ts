...
// const TempOwnedVehicle: { [vehicle_id: string]: number };

// const Internal = {
//     init() {
//         alt.onClient(VEHICLE_EVENTS.SET_LOCK, VehicleSystem.toggle.asPlayer.lock);
//         alt.onClient(VEHICLE_EVENTS.SET_ENGINE, VehicleSystem.toggle.asPlayer.engine);
//         alt.onClient(VEHICLE_EVENTS.SET_DOOR, VehicleSystem.toggle.asPlayer.door);
//         alt.on('playerEnteringVehicle', Internal.entering);
//         alt.on('playerEnteredVehicle', Internal.enter);
//         alt.on('playerLeftVehicle', Internal.leave);
//         alt.on('vehicleDestroy', Internal.destroyed);
//         alt.on('removeEntity', Internal.removeEntity);
//     },
//     /**
...
//      */
//     applyState(vehicle: alt.Vehicle, state: VehicleState) {
//         Object.keys(state).forEach((key) => {
//             vehicle[key] = state[key];
//         });
//     },
//     enter(player: alt.Player, vehicle: alt.Vehicle, seat: number) {
//         //
//     },
//     entering(player: alt.Player, vehicle: alt.Vehicle, seat: number) {
//         //
//     },
//     leave(player: alt.Player, vehicle: alt.Vehicle, seat: number) {
//         if (seat === SEAT.DRIVER) {
//             Internal.update(vehicle);
//         }
...
//         }, 500);
//     },
//     destroyed(vehicle: alt.Vehicle) {
//         //
//     },
//     removeEntity(entity: alt.Entity) {
//         if (!(entity instanceof alt.Vehicle)) {
//             return;
//         }

//         delete TempOwnedVehicle[entity.id];
//     },
//     toggleLock(vehicle: alt.Vehicle) {
//         //
//     },
//     toggleEngine(vehicle: alt.Vehicle) {
//         //
//     },
//     toggleDoor(vehicle: alt.Vehicle) {
//         //
//     },
//     update(vehicle: alt.Vehicle) {
//         //
...
//          */
//         temporary(vehicleInfo: VehicleSpawnInfo): alt.Vehicle {
...
//          * @return {alt.Vehicle}
//          */
//         temporaryOwned(player: alt.Player, vehicleInfo: VehicleSpawnInfo): alt.Vehicle {
//             const vehicle = new alt.Vehicle(vehicleInfo.model, vehicleInfo.pos, vehicleInfo.rot);
//             TempVehicles.push(vehicle.id);
//             TempOwnedVehicle[vehicle.id] = player.id;
//             return vehicle;
//         },
//         /**
...
//          */
//         persistent(document: OwnedVehicle): alt.Vehicle {
//             const vehicle = new alt.Vehicle(document.model, document.pos, document.rot);
//             Internal.applyState(vehicle, document.state);
//             return vehicle;
//         },
//     },
//     toggle: {
//         lock(vehicle: alt.Vehicle) {
//             //

//             Internal.toggleLock(vehicle);
//         },
//         door(vehicle: alt.Vehicle, door: number) {
//             //

//             Internal.toggleDoor(vehicle);
//         },
//         engine(vehicle: alt.Vehicle) {
//             //

//             Internal.toggleEngine(vehicle);
//         },
//         asPlayer: {
//             lock(player: alt.Player, vehicle: alt.Vehicle) {
//                 //

//                 Internal.toggleDoor(vehicle);
//             },
//             door(player: alt.Player, vehicle: alt.Vehicle, door: number) {
//                 //

//                 Internal.toggleDoor(vehicle);
//             },
//             engine(player: alt.Player, vehicle: alt.Vehicle) {
//                 //
...
//             return [...alt.Vehicle.all].filter((veh) => {
//                 return TempVehicles.indexOf(veh.id) !== -1;
//             });
//         },
//     },
//     is: {
//         temporaryVehicle(vehicle: alt.Vehicle) {
//             return TempVehicles.indexOf(vehicle.id) !== -1;
//         },
//     },
//     has: {
//         ownership(player: alt.Player, vehicle: alt.Vehicle) {
//             // Check if the owner of the vehicle is the player.
//             // Non-owned vehicles always return false
//             const vehData = Athena.document.vehicle.get(vehicle);
//             if (typeof vehData === 'undefined') {
//                 return false;
//             }
//         },
//         permission(player: alt.Player, vehicle: alt.Vehicle) {
//             // Non-owned vehicles always return true
//             // Check if the player has valid character permission, or their id is in the keys list of the vehicle doc.
//         },
//     },
//     set: {
//         mods(vehicle: alt.Vehicle, mods: Array<{ id: number; value: number }>, save = false) {
//             //
//         },
//         modkit(vehicle: alt.Vehicle, kit: number, save = false) {
//             // check if kit count exceeds
//         },
//     },
// };
