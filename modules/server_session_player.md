...
[server/session/player.ts:122](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L122)
...
[server/session/player.ts:100](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L100)
...
[server/session/player.ts:59](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L59)
...
[server/session/player.ts:148](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L148)
...
[server/session/player.ts:81](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L81)
...
[server/session/player.ts:36](https://github.com/Stuyk/altv-athena/blob/01dffad/src/core/server/session/player.ts#L36)
